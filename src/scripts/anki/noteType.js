...
export const ANKI_CSS = [
  ...
  '.reg{font-size:.58rem;font-family:"Oswald",sans-serif;font-weight:700;text-transform:uppercase;color:#64748b;padding:.18rem .5rem;border:1px solid rgba(100,116,139,.35);border-radius:6px;white-space:nowrap;order:-1;}',
