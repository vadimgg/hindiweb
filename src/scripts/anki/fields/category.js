...
export function buildAnkiCategory(word) {
  ...
  return `<span style="display:inline-block;font-size:.7rem;font-family:'Oswald',sans-serif;font-weight:700;text-transform:uppercase;letter-spacing:.1em;padding:.2rem .65rem;border-radius:6px;${style}">${esc(word.pos)}</span>`;
}
